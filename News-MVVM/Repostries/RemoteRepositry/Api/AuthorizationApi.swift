...
extension AuthorizationApi:TargetType , AccessTokenAuthorizable{
    ...
    var task : Task {
        ...
        case .loginRequest(let credentials):
            return .requestParameters(parameters: [AuthorizationParamters.UserName: credentials.userName,AuthorizationParamters.Password: credentials.password,AuthorizationParamters.DeviceToken:Key.DeviceType], encoding: JSONEncoding.default)
        }
    }
